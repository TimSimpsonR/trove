...
class API(object):
    ...
    def __init__(self, context, id):
        ...
        version_cap = self.VERSION_ALIASES.get(CONF.upgrade_levels.guestagent)
    ...
    def get_user(self, username, hostname):
        ...
        return self._call("get_user", AGENT_LOW_TIMEOUT, '3.0',
    ...
    def list_access(self, username, hostname):
        ...
        LOG.debug("User name is %s" % username)
        return self._call("list_access", AGENT_LOW_TIMEOUT, '3.0',
                          username=username, hostname=hostname)

    def grant_access(self, username, hostname, databases):
        """Grant a user permission to use a given database."""
        return self._call("grant_access", AGENT_LOW_TIMEOUT, '3.0',
                          username=username, hostname=hostname,
                          databases=databases)

    def revoke_access(self, username, hostname, database):
        """Remove a user's permission to use a given database."""
        return self._call("revoke_access", AGENT_LOW_TIMEOUT, '3.0',
                          username=username, hostname=hostname,
                          database=database)
    ...
    def list_users(self, limit=None, marker=None, include_marker=False):
        ...
        return self._call("list_users", AGENT_LOW_TIMEOUT, '3.0', limit=limit,
    ...
    def delete_user(self, user):
        ...
        self._cast("delete_user", '3.0', user=user)
    ...
    def delete_database(self, database):
        ...
        LOG.debug(_("Deleting database %(database)s for "
                    "Instance %(instance_id)s") % {'database': database,
                                                   'instance_id': self.id})
        self._cast("delete_database", '3.0', database=database)
    ...
    def enable_root(self):
        ...
        return self._call("enable_root", AGENT_HIGH_TIMEOUT, '3.0')
    ...
    def disable_root(self):
        ...
        return self._call("disable_root", AGENT_LOW_TIMEOUT, '3.0')
    ...
    def prepare(self, memory_mb, packages, databases, users,
        ...
        self._cast(
            "prepare", '3.0', packages=packages, databases=databases,
    ...
    def get_volume_info(self):
        ...
        return self._call("get_filesystem_stats", AGENT_LOW_TIMEOUT, '3.0',
                          fs_path=None)

    def update_guest(self):
        """Make a synchronous call to update the guest agent."""
        self._call("update_guest", AGENT_HIGH_TIMEOUT, '3.0')
    ...
    def create_backup(self, backup_info):
        ...
        self._cast("create_backup", '3.0', backup_info=backup_info)
    ...
    def mount_volume(self, device_path=None, mount_point=None):
        ...
        self._call("mount_volume", AGENT_LOW_TIMEOUT, '3.0',
    ...
    def unmount_volume(self, device_path=None, mount_point=None):
        ...
        self._call("unmount_volume", AGENT_LOW_TIMEOUT, '3.0',
                   device_path=device_path, mount_point=mount_point)
    ...
    def resize_fs(self, device_path=None, mount_point=None):
        ...
        LOG.debug("Resize device %(device)s on instance %(id)s." % {
            'device': device_path, 'id': self.id})
        self._call("resize_fs", AGENT_HIGH_TIMEOUT, '3.0',
                   device_path=device_path, mount_point=mount_point)
    ...
    def get_replication_snapshot(self, snapshot_info=None):
        ...
        return self._call("get_replication_snapshot", AGENT_HIGH_TIMEOUT,
                          '3.0', snapshot_info=snapshot_info)
    ...
    def attach_replication_slave(self, snapshot, slave_config=None):
        ...
        self._cast("attach_replication_slave", '3.0', snapshot=snapshot,
                   slave_config=slave_config)

    def detach_replica(self):
        LOG.debug("Detaching replica %s from its replication source.", self.id)
        self._call("detach_replica", AGENT_HIGH_TIMEOUT, '3.0')

    def demote_replication_master(self):
        LOG.debug("Demoting instance %s to non-master.", self.id)
        self._call("demote_replication_master", AGENT_LOW_TIMEOUT, '3.0')
